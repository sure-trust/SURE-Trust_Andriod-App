 ...
 */
public abstract class Hilt_LatestUpdatesDialogFragment extends BaseDialogFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LatestUpdatesDialogFragment_GeneratedInjector) this.generatedComponent()).injectLatestUpdatesDialogFragment(UnsafeCasts.<LatestUpdatesDialogFragment>unsafeCast(this));
    }
  }
