 ...
 */
public abstract class Hilt_ExploreCourseFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ExploreCourseFragment_GeneratedInjector) this.generatedComponent()).injectExploreCourseFragment(UnsafeCasts.<ExploreCourseFragment>unsafeCast(this));
    }
  }
