 ...
 */
public abstract class Hilt_AboutDeveloperFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AboutDeveloperFragment_GeneratedInjector) this.generatedComponent()).injectAboutDeveloperFragment(UnsafeCasts.<AboutDeveloperFragment>unsafeCast(this));
    }
  }
