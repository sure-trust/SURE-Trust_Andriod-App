 ...
 */
public abstract class Hilt_ResearchFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ResearchFragment_GeneratedInjector) this.generatedComponent()).injectResearchFragment(UnsafeCasts.<ResearchFragment>unsafeCast(this));
    }
  }
