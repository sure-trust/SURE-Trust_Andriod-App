 ...
 */
public abstract class Hilt_AboutFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AboutFragment_GeneratedInjector) this.generatedComponent()).injectAboutFragment(UnsafeCasts.<AboutFragment>unsafeCast(this));
    }
  }
