 ...
 */
public abstract class Hilt_GuidanceFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((GuidanceFragment_GeneratedInjector) this.generatedComponent()).injectGuidanceFragment(UnsafeCasts.<GuidanceFragment>unsafeCast(this));
    }
  }
